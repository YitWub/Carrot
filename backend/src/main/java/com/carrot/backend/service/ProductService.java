...
public class ProductService {
    ...
    @Transactional
    public ProductCreateResponse createProduct(String title, String content, Integer price, Long sellerId, List<MultipartFile> images) {
    ...
    public void updateProduct(Long productId, Long userId, com.carrot.backend.dto.ProductUpdateRequest request) {
        ...
        if (request.content() != null) product.setContent(request.content());
